    ...
    updateSeq=()=>{
       ...
       // console.log("updateSeq",this.props);
        ...
        if(this.props.mapData.length!==0){
            ...
            if((this.props.sequences[0]===undefined||this.props.sequences[0]===[])&&seq[0]!==undefined){
            ...
            {if(this.props.sequences[0].toString()===seq[0].toString())
            {
                console.log("!!!!!");
            }
            else{this.props.updateSequences(seq);}}
        }  
        }
    }
