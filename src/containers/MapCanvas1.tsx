...
import {Select, Tooltip, Alert} from 'antd';
...
class MapCanvas1 extends React.Component<any, any> {
    ...
    render() {console.log("seq",this.props.seq);
        return (
            this.state.TOPIC?(
                <div id="topic_kaishi" style={{ position: "relative", top: "50%", marginTop: "-50vw" }}>
    ...
    componentDidMount() {
                ...
                drawTopic(comId, this.props.mapData, svg as HTMLElement, (d: any) => {
                    ...
                    if(d===-1){
                        const tElement = document.getElementById(comId+'nodes');
                        //@ts-ignore
                ...
                let direction1;
                let that = this;
                var map = document.getElementById('topic_kaishi');
